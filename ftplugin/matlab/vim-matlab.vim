...
if g:matlab_auto_mappings
  ...
  vnoremap <buffer><silent> <leader><C-m> <ESC>:MatlabCliRunSelection<CR>
  nnoremap <buffer><silent> <leader><C-m> <ESC>:MatlabCliRunCell<CR>
  nnoremap <buffer><silent> <leader><C-h> :MatlabCliRunLine<CR>
  ...
  nnoremap <buffer><silent> <leader>cc :MatlabCliCancel<CR>
  nnoremap <buffer><silent> <leader><C-l> :MatlabNormalModeCreateCell<CR>
  vnoremap <buffer><silent> <leader><C-l> :<C-u>MatlabVisualModeCreateCell<CR>
  inoremap <buffer><silent> <leader><C-l> <C-o>:MatlabInsertModeCreateCell<CR>
endif
